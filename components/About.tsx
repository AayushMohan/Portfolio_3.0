...
const About = (props: Props) => {
  return (
    ...
    >
      <h3 className="text-center md:absolute top-24 md:-ml-16 uppercase tracking-[12px] md:tracking-[20px] text-gray-500 text-4xl">
        About
      </h3>
      ...
      <motion.img
        ...
        className="md:mb-0 flex-shrink-0 w-40 h-40 rounded-full object-cover md:rounded-lg md:w-64 xl:w-[400px] xl:h-[500px]"
